...
def check_password_strength():
    ...
    list1_path = os.path.join(script_dir, 'password_list1.txt')
    list2_path = os.path.join(script_dir, 'password_list2.txt')
    list3_path = os.path.join(script_dir, 'password_list3.txt')
...
def show_custom_message(title, message, color):
    ...
    custom_msg.configure(bg="#2e2e2e", borderwidth=1.5, relief="solid")
...
root.configure(bg="#16537e", borderwidth=1.5, relief="solid")

Label(root, text="Enter Password:", bg="#1c1c1c", fg="white", font=("Helvetica", 12), borderwidth=1.5, relief="solid").place(x=50, y=20)
entry_password = Text(root, height=1, width=30, font=("Helvetica", 12), borderwidth=1.5, relief="solid")
entry_password.place(x=180, y=20)

b_check = Button(root, text="Check Strength", command=check_password_strength, bg="#4CAF50", fg="white", font=("Helvetica", 12, "bold"), borderwidth=1.5, relief="solid")
